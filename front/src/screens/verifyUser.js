                    ...
                    <tbody>
                        ...
                        {usersToVerify && usersToVerify.ToVerify && usersToVerify.ToVerify.map((val, index)=>(
                            <tr key={index}>
                                ...
                                <td>{val[2]}</td>
                                <td>{val[3]}</td>
                                <td><button className="btn btn-warning" id="buttonQr" data-toggle="modal" data-target="#exampleModal" onClick={() =>setSrc(val[4])}>View</button></td>
                                <td className="pepeFlex">
                                        <button className="btn btn-success" id="pepeButton" data-toggle="modal" data-target="#viewModal" onClick={()=>{setUserId(val[0]); setuser(val[5])}} ><i className="fa-solid fa-circle-check"></i></button>
                                        <button className="btn btn-danger" id="pepeButo" data-toggle="modal" data-target="#rejectModal" onClick={()=>{setUserId(val[0]); setuser(val[5])}} ><i className="fa-solid fa-rectangle-xmark"></i></button>
                                    </td>
                            </tr>
                        ))}
                    </tbody>
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        ...
                        <img className="samplepic" src={imgSrc}/>
                        </div>
