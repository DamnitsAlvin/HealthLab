                ...
                <div className="tableContainer">
                    {
                        userInfo.data[2] == "user" ? (
                            ...
                            <div className="table-wrapper">
                                ...
                                {
                                    DeleteSuccess && (<div id="inter" className="alert alert-success">Booking Cancelled</div>)
                                }
                                        ...
                                        {appointments && appointments.Appointments &&
                                            appointments.Appointments.map((appoint, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td>   <button className="btn btn-danger"data-toggle="modal" data-target="#cancelModal">Cancel</button></td>
                                                </tr>
                                            ))
                                        }
                                    </tbody>
